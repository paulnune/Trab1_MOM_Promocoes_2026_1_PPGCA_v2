...
# Cliente Curioso quer livro E destaque -> faz 2 bindings na mesma fila.
binding_keys = ['promocao.#']
...
print(f' [*] Cliente Curioso esperando em {queue_name}. Bindings: {binding_keys}. CTRL+C para sair.')


def callback(ch, method, properties, body):
    # method.routing_key te diz qual key veio (útil pra log/debug)
    print(f" [x] Cliente Curioso recebeu [{method.routing_key}]: {body!r}")
